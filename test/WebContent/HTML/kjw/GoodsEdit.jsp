...
<body>
	<div>
		<form method="post" action="goodsEditOk" encType="multipart/form-data">
			<table>
				<tr>
					<td>상품명</td>
				...
				<tr>
					<td rowspan="1"><input type="submit" value="수정"><input type="reset" value="취소"><button onclick="location.href='goodsList.do'">목록가기</button></td>
				</tr>
			</table>
		</form>
	</div>
