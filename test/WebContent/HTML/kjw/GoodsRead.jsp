...
$("#back_Btn").click(function(){
 location.href = "goodsDeleteOne.do" + ${dto[0].g_num };
});   
-->
</script>
</head>
<body>
	<div align="center">
		<div>
			<form name="frm" id="frm" method="post" action="goodsEdit.do" >
				<input type="hidden" id="id" name="id">
				<table border="1">
					<tr>
						<td>상품번호</td>
						<td><input type="hidden" id="num" name="num" value="${dto[0].g_num }">${dto[0].g_num }</td>
					</tr>
					<tr>
					    
						<td>상품명</td>
						<td><input type="text" id="name" name="name" value="${dto[0].g_name }"></td>
					</tr>
					<tr>
						<td>판매가</td>
						<td><input type="text" id="grice" name="grice" value="${dto[0].g_price }"></td>
					</tr>
					<tr>
						<td>공급가</td>
						<td><input type="text" id="srice" name="srice" value="${dto[0].s_price }"></td>
					</tr>
					<tr>
						<td>사이즈</td>
					...
					<tr>
						<td>색상</td>
						<td><input type="text" id="color" name="color" value="${dto[0].color }"></td>
					</tr>
					<tr>
						<td>재고유무</td>
					...
					<tr>
						<td>제조사</td>
						<td><input type="text" id="maker" name="maker" value="${dto[0].maker }"></td>
					</tr>
					<tr>
						<td>상품이미지</td>
						<td><img alt=""
					...
					<tr>
						<td>진열우선순위</td>
						<td><input type="text" id="prior" name="prior" value="${dto[0].g_prior}"></td>
					</tr>
					<tr>
						<td>상품상태</td>
