								...
								<div class="card has-background border-0 bg-default">
									...
									<div class="card-body">
										<h3 class="font-weight-normal">
											50% off<br>Winter Collection
										</h3>
										<p class="text-mute">Best product and collections</p>
										<div class="text-right">
											<a href="" class="btn btn-sm btn-white text-uppercase">Show
												Now</a>
										</div>
									</div>
								</div>
				...
				<div class="container-fluid bg-purple-light">
					<div class="row no-gutters">
						<div class="col-7 py-4">
							...
							<a href="" class="btn btn-sm btn-default text-uppercase">Show
								Now</a>
						</div>
							...
							<div class="card border-0 mb-4">
								<div class="card-body p-0">
									<div class="h-150px has-background rounded mb-2">
										...
										<a href="product.html" class="background"> <img
											src="../assets/img/image4.jpg" alt="">
										</a>
									</div>
				...
				<div class="container">
					<div class="media my-3 w-100">
						<div class="avatar avatar-60 mr-3 has-background rounded">
							...
							<a href="product.html" class="background"> <img
								src="../assets/img/image9.jpg" class="" alt="">
							</a>
						</div>
						<div class="media-body">
							<small class="text-mute">Rockstar</small> <a href="product.html">
									...
									<div class="card border-0 mb-4">
										<div class="card-body p-0">
											<a href="product.html"
												...
												<figure class="background"
													style="background-image: url(&quot;../assets/img/image4.jpg&quot;);">
													<img src="../assets/img/image4.jpg" alt=""
														style="display: none;">
												</figure>
									...
									<div class="card border-0 mb-4">
										<div class="card-body p-0">
											<div class="h-150px has-background rounded mb-2">
												...
												<figure class="background"
													style="background-image: url(&quot;../assets/img/image6.jpg&quot;);">
													<img src="../assets/img/image6.jpg" alt=""
														style="display: none;">
												</figure>
											</div>
				...
				<div class="col-11 col-md-6 col-lg-4 mx-auto">
					...
					<div class="list-group my-3">
						<a href="#" class="list-group-item list-group-item-action">Account
							...
							Addresses <i class="material-icons float-right text-mute h6 my-0">keyboard_arrow_right</i>
