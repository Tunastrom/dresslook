    ...
    <div class="container-fluid h-100 pageloader">
        <div class="row h-100">
            <div class="col-12 align-self-center">
                ...
                <h2 class="text-uppercase font-weight-medium text-white">DressLook</h2>
            ...
            <div class="row no-gutters">
                ...
                <div class="col">
                    <div class="logo-header">
                        ...
                        <h5 class="logo-header-text"><span class="text-uppercase">DressLook</span><br><small>Mobile HTML template</small></h5>
                    </div>
                </div>
                <div class="col-auto">
                ...
                <div class="row">
                    <div class="container align-self-start my-3">
                                    ...
                                    <div class="swiper-wrapper pb-4">
                                        <div class="swiper-slide shadow card w-300px overflow-hidden gradient-default border-0 ">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <p>Noh sang hyeon<br><small class="text-mute">Name</small></p>
                                                    </div>
                                                    <div class="col text-right">
                                                        <p>10/24<br><small class="text-mute">Expiry</small></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide shadow card w-300px overflow-hidden gradient-green text-white border-0 ">
                                            ...
                                            <div class="card-body">
                                                <br>
                                                <h4 class="font-weight-normal">**** **** **** 3348</h4>
                                                <div class="row">
                                                    <div class="col">
                                                        <p>Noh sang hyeon<br><small class="text-mute">Name</small></p>
                                                    </div>
                                                    <div class="col text-right">
                                                        <p>11/23<br><small class="text-mute">Expiry</small></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide shadow card w-300px overflow-hidden gradient-blue text-white border-0 ">
                                            ...
                                            <div class="card-body">
                                                <br>
                                                <h4 class="font-weight-normal">**** **** **** 1212</h4>
                                                <div class="row">
                                                    <div class="col">
                                                        <p>Noh sang hyeon<br><small class="text-mute">Name</small></p>
                                                    </div>
                                                    <div class="col text-right">
                                                        <p>12/22<br><small class="text-mute">Expiry</small></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group float-label position-relative active">
                                    <input type="text" class="form-control " value="10/24">
