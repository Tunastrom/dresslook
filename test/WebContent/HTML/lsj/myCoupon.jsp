					...
					<div class="container">
						<div class="media my-3 w-100">
							...
							<div class="media-body">
								...
								<p class="small">${CouponDto.c_price }
									<br>${CouponDto.c_limit }</p>
							</div>
						...
						<div class="media my-3 w-100">
							...
							<div class="media-body">
								<small class="text-mute">${GoodsDto.g_maker }</small>
								<p class="mb-1">${GoodsDto.g_name }</p>
								<p class="small">${CouponDto.c_price }<br>${CouponDto.c_limit }</p>
							</div>
							<div class="align-self-center">
								<button class="btn btn-white btn-rounded btn-40">
									<i class="material-icons ">delete</i>
						...
						<div class="media my-3 w-100">
							...
							<div class="media-body">
								...
								<p class="mb-1">${GoodsDto.g_name }</p>
								<p class="small">
									<b>${CouponDto.c_price }</b> ${CouponDto.c_usage }
								</p>
							</div>
							<div class="align-self-center">
								<button class="btn btn-white btn-rounded btn-40">
							...
							<div class="col-6 col-md-4 col-lg-3">
								<div class="card border-0 mb-4">
									<div class="card-body p-0">
										...
										<small class="text-mute">${GoodsDto.g_maker }</small>
										<p class="mb-0">${GoodsDto.g_name }</p>
										<p class="small">${CouponDto.c_price }
											<br>${CouponDto.c_limit }</p>
									</div>
								</div>
