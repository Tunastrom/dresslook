...
<link rel=icon
	href="${pageContext.request.contextPath}/HTML/assets/img/logo-small.svg"
	sizes="any">
...
<link
	href="${pageContext.request.contextPath}/HTML/assets/vendor/materializeicon/material-icons.css"
	rel="stylesheet">
...
<!-- swiper stylesheet -->
<link
	href="${pageContext.request.contextPath}/HTML/assets/vendor/swiper/css/swiper.min.css?ver=2"
	rel="stylesheet">

<!-- template stylesheet -->
<link
	href="${pageContext.request.contextPath}/HTML/assets/css/style-red.css?ver=5"
	rel="stylesheet" id="style">

<!-- Template js files -->
<script
	src="${pageContext.request.contextPath}/HTML/assets/js/jquery-3.3.1.min.js"></script>
<script
	src="${pageContext.request.contextPath}/HTML/assets/js/popper.min.js"></script>
<script
	src="${pageContext.request.contextPath}/HTML/assets/vendor/bootstrap-4.4.1/js/bootstrap.min.js"></script>

<!-- Swiper javascript -->
<script
	src="${pageContext.request.contextPath}/HTML/assets/vendor/swiper/js/swiper.min.js"></script>
...
<script
	src="${pageContext.request.contextPath}/HTML/assets/vendor/cookie/jquery.cookie.js"></script>

<!-- Color scheme js -->
<script
	src="${pageContext.request.contextPath}/HTML/assets/js/color-scheme-demo.js"></script>

<!-- App js page level initialization functions -->
<script
	src="${pageContext.request.contextPath}/HTML/assets/js/app.js?ver=1"></script>
<style>
.page-title {
	font-weight: bold;
	color: #f94620;
...
<body class="ui-rounded sidebar-fill header-fill" data-page="homepage"> 
    <div class="sidebar sidebar-left overlay-sidebar">
        <div class="content">
            ...
            <div class="list-group list-group-flush nav-list">
                ...
                <a href="/test/timeline.do" class="list-group-item list-group-item-action active"><i class="material-icons">store</i> <span class="text-link">Home</span></a>
                <a href="/test/goodsList.do" class="list-group-item list-group-item-action"><i class="material-icons">view_carousel</i> <span class="text-link">상품관리</span></a>
                <a href="/test/notifications.do" class="list-group-item list-group-item-action"><i class="material-icons">notifications</i> <span class="text-link">주문관리</span></a>
                <a href="/test/myProfile.do" class="list-group-item list-group-item-action"><i class="material-icons">local_offer</i> <span class="text-link">offers</span></a>
           		</c:if>
            </div>
                <c:choose>
	...
	<div class="main-container">
		<header class="header">
			<div class="row no-gutters">
				<div class="col-auto">
					<button id="backButton" class="btn btn-link menu-btn-left">
						<i class="material-icons" id="backbtnText">menu</i>
					</button>
				</div>
				<div class="col">
					<div class="logo-header">
						...
						<h5 class="logo-header-text">
							<span class="text-uppercase">dresslook</span><br>
							<small>LOOKing every wear</small>
						</h5>
					</div>
				</div>
				<div class="col-auto">
					<a href="like.do" class="btn btn-link"><i
						class="material-icons">favorite_border</i></a> <a
						href="notifications.do" class="btn btn-link"> <i
						class="material-icons">notifications_none</i> <span
						class="notification-point"></span>
					</a>
				</div>
			</div>
		</header>
		...
		<footer class="tabs-footer">
			<ul class="nav nav-tabs justify-content-center" id="maintab"
				...
				<li class="nav-item"><a class="nav-link active" id="home-tab"
					href="timeline.do"> <i class="material-icons">store</i> <small
						class="sr-only">Store</small>
				</a></li>
				<li class="nav-item"><a class="nav-link" id="search-tab"
					href="search.do" aria-controls="search" aria-selected="true"> <i
						class="material-icons">find_in_page</i> <small class="sr-only">Search</small>
				</a></li>
				<li class="nav-item"><a class="nav-link" id="cart-tab"
					href="dressRoom.do" aria-controls="cart" aria-selected="true">
						<i class="material-icons">local_mall</i> <span
						class="notification-point"></span> <small class="sr-only">Local
							Mall</small>
				</a></li>
				<li class="nav-item"><a class="nav-link" id="favorite-tab"
					href="collectionMain.do" aria-controls="favorite"
					aria-selected="false"> <i class="material-icons">bookmark</i> <small
						class="sr-only">Bookmarks</small>
				</a></li>
				<li class="nav-item"><a class="nav-link" id="profile-tab"
					href="#profile" aria-controls="profile" aria-selected="false">
						<i class="material-icons">account_circle</i> <small
						class="sr-only">Account</small>
				</a></li>
			</ul>
		</footer>
	</div>
