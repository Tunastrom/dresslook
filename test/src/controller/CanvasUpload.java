...
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, maxFileSize = 1024 * 1024 * 30, maxRequestSize = 1024 * 1024 * 50, location="c:/Temp")
public class CanvasUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;
	   ...
	   private static final String SAVE_DIR = "uploadFiles";
		...
		String appPath =  "c:/Temp"; /*request.getServletContext().getRealPath("/images/looks");*/
	        ...
	        for (Part part : request.getParts()) {
	            ...
	            //String fileName = extractFileName(part); 
	        		...
	        		byte [] l_image = FileUtils.readFileToByteArray(lookFile);
